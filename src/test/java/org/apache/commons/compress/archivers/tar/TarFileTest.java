...
import static org.junit.jupiter.api.Assertions.*;
 ...
 class TarFileTest extends AbstractTestCase {
    ...
    private void createTarFileWithNegativeSizes() throws IOException {
    ...
    private void createTarFileForTruncatedEntries() throws IOException {
    ...
    private void createTarFileTruncatedInContent() throws IOException {
    ...
    private void createTarFileForTruncatedPadding() throws IOException {
    ...
    private void createTarFileWithNonNumberPaxHeaders() throws IOException {
    ...
    private void createTarFileWithSpecialPaxHeaders() throws IOException {
    ...
    private void createTarFile() throws IOException {
        createTarFileWithFilePath("COMPRESS-553.tar");
    }

    private void createTarFileWithFilePath(String filePath) throws IOException {
        new TarFile(getPath(filePath));
    }
    ...
    private void createTarFileForNullEntry() throws IOException {
