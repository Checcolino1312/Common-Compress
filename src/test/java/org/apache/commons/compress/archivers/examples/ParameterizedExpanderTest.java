...
public class ParameterizedExpanderTest extends AbstractTestCase {
    ...
    @ParameterizedTest
    @MethodSource("data")
     void archiveInputStreamVersion(final String format) throws Exception {
    ...
    @ParameterizedTest
    @MethodSource("data")
     void fileVersion(final String format) throws Exception {
        // TODO How to parameterize a BeforeEach method?
        setUp(format);
    ...
    @ParameterizedTest
    @MethodSource("data")
     void inputStreamVersionWithAutoDetection(final String format) throws Exception {
        // TODO How to parameterize a BeforeEach method?
        setUp(format);
        try (InputStream i = new BufferedInputStream(Files.newInputStream(archive.toPath()))) {
