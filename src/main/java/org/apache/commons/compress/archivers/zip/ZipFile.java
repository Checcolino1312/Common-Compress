...
public class ZipFile implements Closeable {
    ...
    private void setSizesAndOffsetFromZip64Extra(final ZipArchiveEntry ze)
        ...
        if (z64 != null) {
            final boolean hasUncompressedSize = z64.getSize() != null;
            final boolean hasCompressedSize = z64.getCompressedSize() != null;
            final boolean hasRelativeHeaderOffset = z64.getRelativeHeaderOffset() != null;
            final boolean hasDiskStart = z64.getDiskStartNumber() != null;
            ...
            if (hasCompressedSize) {
                final long compressedSize = z64.getCompressedSize().getLongValue();
                if (compressedSize < 0) {
                    throw new IOException("broken archive, entry with negative compressed size");
                }
            ...
            if (hasRelativeHeaderOffset) {
                final long relativeHeaderOffset = z64.getRelativeHeaderOffset().getLongValue();
                ze.setLocalHeaderOffset(relativeHeaderOffset);
            }
