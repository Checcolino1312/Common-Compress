...
public class CPInterfaceMethodRef extends CPRef {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CPInterfaceMethodRef)) {
            return false;
        }
        CPInterfaceMethodRef other = (CPInterfaceMethodRef) obj;
        return className.equals(other.className) && nameAndType.equals(other.nameAndType);
    }
