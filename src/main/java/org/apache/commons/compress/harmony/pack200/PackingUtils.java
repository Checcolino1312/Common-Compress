...
public class PackingUtils {
    ...
    public static List<PackingFile> getPackingFileListFromJar(JarFile jarFile, boolean keepFileOrder)
            throws IOException {
        List<PackingFile> packingFileList = new ArrayList<>();
        ...
        // check whether it needs to reorder the packing file list
        if (!keepFileOrder) {
