...
public class LineNumberTableAttribute extends BCIRenumberedAttribute {
    ...
    @Override
    public int hashCode() {
        // Calculate the hash code based on relevant fields used in equals()
        int result = lineNumberTableLength;
        result = 31 * result + Arrays.hashCode(startPcs);
        result = 31 * result + Arrays.hashCode(lineNumbers);
        return result;
    }
