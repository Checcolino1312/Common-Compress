...
public class Segment extends ClassVisitor {
    ...
    public class SegmentFieldVisitor extends FieldVisitor {
        ...
        private static final String UNKNOWN_ATTRIBUTE_ERROR_MESSAGE = "Unknown attribute encountered";
    ...
    public class SegmentMethodVisitor extends MethodVisitor {
        ...
        @Override
        public void visitIincInsn(final int varREF, final int increment) {
            bcBands.visitIincInsn(varREF, increment);
        }
