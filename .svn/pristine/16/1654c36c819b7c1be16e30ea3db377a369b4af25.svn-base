...
public class JarArchiveEntry extends ZipArchiveEntry {
     ...
     */
    private Certificate[] cachedCertificates = null;
    private boolean certificatesInitialized = false;
    ...
    public Certificate[] getCertificates() {
        ...
        if (!certificatesInitialized && certificates != null) {
            cachedCertificates = Arrays.copyOf(certificates, certificates.length);
